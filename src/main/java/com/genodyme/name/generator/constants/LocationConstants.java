...
public class LocationConstants {
  ...
  public static final String DESCRIPTION_PREFIX_FILENAME = "description-prefix.csv";

  public static final String DESCRIPTION_INFIX_FILENAME = "description-infix.csv";

  public static final String DESCRIPTION_SUFFIX_FILENAME = "description-suffix.csv";
